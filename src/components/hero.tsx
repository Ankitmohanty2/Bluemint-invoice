...
export default function Hero() {
  return (
    <section className="relative pt-40 pb-20 px-6 bg-background">
      <div className="max-w-5xl mx-auto relative z-10 flex flex-col items-center text-center">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-full pointer-events-none z-0">
          ...
          <motion.div
            ...
            className="absolute top-[-60px] right-[-10%] bg-yellow-300 w-48 h-48 p-5 shadow-xl flex items-center justify-center pointer-events-auto hover:rotate-12 transition-transform cursor-pointer z-0"
            style={{ boxShadow: "5px 15px 30px rgba(0,0,0,0.15)" }}
          >
            <p className="font-medium text-slate-800 text-lg leading-snug transform -rotate-2 font-secondary text-center">
        ...
        <motion.h1
          ...
          className="text-5xl md:text-7xl font-bold tracking-tight text-foreground max-w-4xl relative z-20 leading-[1.1]"
        >
        ...
        <motion.div
          ...
          className="mt-20 w-full relative h-[400px]"
        >
           {/* Mockup Card 1 */}
           <div className="absolute left-[10%] md:left-[20%] top-0 bg-card/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-border p-6 w-[350px] text-left transform -rotate-3 z-20">
           ...
           {/* Mockup Card 2 */}
           <div className="absolute right-[10%] md:right-[20%] top-12 bg-card/90 backdrop-blur-xl rounded-2xl shadow-2xl border border-border p-6 w-[350px] text-left transform rotate-2 z-10">
             <div className="flex justify-between items-center mb-4">
